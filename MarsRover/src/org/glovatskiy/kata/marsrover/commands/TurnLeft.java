...
public class TurnLeft extends AbstractMoveCommand {
    ...
    protected Position calculateNewPosition(Position position) {
        ...
        switch (position.getDirection()){
            case N: newPosition.setDirection(Direction.W); break;
            case W: newPosition.setDirection(Direction.S); break;
            case S: newPosition.setDirection(Direction.E); break;
            case E: newPosition.setDirection(Direction.N); break;
            default:
        }
        return newPosition;
    }
